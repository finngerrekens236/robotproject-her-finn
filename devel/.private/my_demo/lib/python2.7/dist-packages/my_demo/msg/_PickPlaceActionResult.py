...
"""autogenerated by genpy from my_demo/PickPlaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickPlaceActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "my_demo/PickPlaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_demo/PickPlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickPlaceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_demo.msg.PickPlaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_demo.msg.PickPlaceResult()

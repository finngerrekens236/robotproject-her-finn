...
(cl:defmethod cl:initialize-instance :after ((m <PickPlaceResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PickPlaceResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_demo-msg:<PickPlaceResult> is deprecated: use my_demo-msg:PickPlaceResult instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PickPlaceResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# 2. RESULT (Wat de robot terugstuurt als hij klaar is)~%bool success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PickPlaceResult)))
  "Returns full string definition for message of type 'PickPlaceResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# 2. RESULT (Wat de robot terugstuurt als hij klaar is)~%bool success~%~%~%~%"))

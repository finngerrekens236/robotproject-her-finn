...
"""autogenerated by genpy from hoofdprogramma/PickAndPlaceAction.msg. Do not edit."""
import codecs
import sys
...
import hoofdprogramma.msg
import std_msgs.msg

class PickAndPlaceAction(genpy.Message):
  _md5sum = "efb3b3ef055f6751ffd497bf5460f802"
  _type = "hoofdprogramma/PickAndPlaceAction"
...
"""
  ...
  _slot_types = ['hoofdprogramma/PickAndPlaceActionGoal','hoofdprogramma/PickAndPlaceActionResult','hoofdprogramma/PickAndPlaceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = hoofdprogramma.msg.PickAndPlaceActionGoal()
      if self.action_result is None:
        self.action_result = hoofdprogramma.msg.PickAndPlaceActionResult()
      if self.action_feedback is None:
        self.action_feedback = hoofdprogramma.msg.PickAndPlaceActionFeedback()
    else:
      self.action_goal = hoofdprogramma.msg.PickAndPlaceActionGoal()
      self.action_result = hoofdprogramma.msg.PickAndPlaceActionResult()
      self.action_feedback = hoofdprogramma.msg.PickAndPlaceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.kwast_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.kwast_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.kwast_type = str[start:end]
      _x = self
      start = end
      end += 12

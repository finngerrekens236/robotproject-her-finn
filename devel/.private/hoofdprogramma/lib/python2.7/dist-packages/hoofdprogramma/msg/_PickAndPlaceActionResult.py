...
"""autogenerated by genpy from hoofdprogramma/PickAndPlaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickAndPlaceActionResult(genpy.Message):
  ...
  _type = "hoofdprogramma/PickAndPlaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hoofdprogramma/PickAndPlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = hoofdprogramma.msg.PickAndPlaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hoofdprogramma.msg.PickAndPlaceResult()

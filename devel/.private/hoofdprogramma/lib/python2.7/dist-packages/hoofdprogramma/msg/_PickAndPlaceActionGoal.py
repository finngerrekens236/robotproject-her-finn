...
"""autogenerated by genpy from hoofdprogramma/PickAndPlaceActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PickAndPlaceActionGoal(genpy.Message):
  _md5sum = "ff5ad01e1100f1af47ffa22eebb8d7e6"
  _type = "hoofdprogramma/PickAndPlaceActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hoofdprogramma/PickAndPlaceGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = hoofdprogramma.msg.PickAndPlaceGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hoofdprogramma.msg.PickAndPlaceGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.kwast_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.kwast_type = str[start:end]
      return self

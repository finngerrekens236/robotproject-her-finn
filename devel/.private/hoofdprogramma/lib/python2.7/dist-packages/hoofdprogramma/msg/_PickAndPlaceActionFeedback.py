...
"""autogenerated by genpy from hoofdprogramma/PickAndPlaceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PickAndPlaceActionFeedback(genpy.Message):
  _md5sum = "be0fa7a9875c8a7ee0a9d912ee3f86c9"
  _type = "hoofdprogramma/PickAndPlaceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hoofdprogramma/PickAndPlaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = hoofdprogramma.msg.PickAndPlaceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hoofdprogramma.msg.PickAndPlaceFeedback()

...
"""autogenerated by genpy from hoofdprogramma/PickAndPlaceGoal.msg. Do not edit."""
import codecs
import sys
...
class PickAndPlaceGoal(genpy.Message):
  _md5sum = "47e7aaf017f8edd9f55a55a7c9dda08b"
  _type = "hoofdprogramma/PickAndPlaceGoal"
...
float64 w
"""
  __slots__ = ['target_pose','kwast_type']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.kwast_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.kwast_type = str[start:end]
      return self

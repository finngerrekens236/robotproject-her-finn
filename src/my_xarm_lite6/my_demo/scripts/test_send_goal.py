...
def main():
    ...
    goal.target_pose.position.x = -0.122348003112
    goal.target_pose.position.y = -0.276515803629
    ...
    goal.target_pose.orientation.z = -0.22821738467
    goal.target_pose.orientation.w = 0.973610201947

...
class Hoofdprogramma(object):
    ...
    def run_cycle(self, requested_type):
        ...
        # --------------------------------------------------
        detected_type = detection.object_type.lower()
        ...
        if detected_type != requested_type:
            rospy.logwarn('object type komt niet overeen')
            return False
    ...
    def send_robot_goal(self, pose, object_type, target_bin):
        """
    ...
    def get_target_bin(self, object_type):
        """
        ...
        mapping = {
            ...
            'Lepel': 'BakRO',
            'Vork': 'BakLB',
            'Schroevendraaier': 'BakLO'
        }

        return mapping.get(object_type, 'home')
